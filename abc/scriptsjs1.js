 (function() {
      ...
      const universityData = {
        ...
        "medium": "English",
        "recognition": ["NMC", "WHO"],
        "image": "https://placehold.co/600x400/0f4c81/white?text=Pskov+State+University",
        "description": "Pskov State University is one of the leading classical universities in Northwestern Russia, offering high-quality MBBS programs in English. The university combines modern medical infrastructure with affordable tuition, attracting students from across the globe.",
        "hostel": "Available",
